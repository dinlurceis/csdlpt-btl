...
ACTUAL_ROWS_IN_INPUT_FILE = 1e7 + 54  # Number of lines in the input file
...
if __name__ == '__main__':
    try:
        ...
        with testHelper.getopenconnection(dbname=DATABASE_NAME) as conn:
            ...
            [result, e] = testHelper.testrangeinsert(MyAssignment, RATINGS_TABLE, 100, 2, 3, conn, '1')
            ...
            [result, e] = testHelper.testroundrobinpartition(MyAssignment, RATINGS_TABLE, 3, conn, 0, ACTUAL_ROWS_IN_INPUT_FILE)
            if result :
